...
set(EXECUTABLE_OUTPUT_PATH ${PROJECT_SOURCE_DIR}/bin/elf)
#set the default path for built libraries to the "lib" directory
set(LIBRARY_OUTPUT_PATH ${PROJECT_SOURCE_DIR}/lib)
#set the default path for built libraries to the "map" directory
set(MAP_OUTPUT_PATH ${PROJECT_SOURCE_DIR}/bin/map)
#set the default path for built libraries to the "hex" directory
set(HEX_OUTPUT_PATH ${PROJECT_SOURCE_DIR}/bin/hex)
#set the default path for built libraries to the "elf" directory
set(ELF_OUTPUT_PATH ${PROJECT_SOURCE_DIR}/bin/elf)
#set the default path for built libraries to the "elf" directory
set(EEPROM_OUTPUT_PATH ${PROJECT_SOURCE_DIR}/bin/eep)
#set the default path for built libraries to the "cmake" directory
...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   # set file names
   set(elf_file ${EXECUTABLE_OUTPUT_PATH}/${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENAME}.elf)
   ...
   # elf file
   add_executable(${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENAME}.elf EXCLUDE_FROM_ALL ${ARGN})

   set_target_properties(
     ${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENAME}.elf
      PROPERTIES
